...
\input{./Chapters/Chapter3} % WSN Platform

\input{./Chapters/Chapter4} % Approach to Reconfiguration

\input{./Chapters/Chapter5} % Software Implementation

\input{./Chapters/Chapter6} % Automated Agents
