...
public class SM_MirrorDemo extends ControlClass implements java.io.Serializable  { 
	...
	private static String confirmation = "Last Edit: 10/13/2015 - 12:15 PM";
	 ...
	 * @param expID
	 */
	public SM_MirrorDemo(String expID, String expDesc, String sinkServerAddress,String gardenServerName,boolean init) {
	...
	protected RBNBControl createRBNBControl(){
		...
		public class RBNBControl extends ControlClass.RBNBControl{
	    	...
	    	try{ 
			        ...
			        double STM_SM_Orig_Epsilon,STM_SM_Mirror_Epsilon;
					...
					STM_SM_Orig_Epsilon = -1;
        			STM_SM_Mirror_Epsilon = -1;
				        /*
