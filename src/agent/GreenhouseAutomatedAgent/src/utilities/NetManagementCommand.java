...
public abstract class NetManagementCommand {
	...
	protected String pubTopic = "bio17/cmd/gh_agent";
	protected int qos = 2;
	protected String broker = "tcp://bio17.bio.nau.edu:1883";
	String pubId = "gh_agent/cmd_publisher";
	...
	public void runCommand(){
		...
		try{
			...
			System.out.println("published command to " + pubTopic);
			//publish packet 2
